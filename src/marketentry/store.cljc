(ns marketentry.store
  "SSoT for the THA market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems TH" :portal "e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-th-entity? true :has-th-entity? true
             :requires-dbd? true :dbd-verified? true
             :drafted? false :submitted? false
             :jurisdiction "THA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-th-entity? true :has-th-entity? true
             :requires-dbd? true :dbd-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "THA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-th-entity? true :has-th-entity? false
             :requires-dbd? true :dbd-verified? true
             :drafted? false :submitted? false
             :jurisdiction "THA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-GP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-th-entity? true :has-th-entity? true
             :requires-dbd? true :dbd-verified? false
             :drafted? false :submitted? false
             :jurisdiction "THA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-GP"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-th-entity? has-th-entity?
                               requires-dbd? dbd-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-th-entity?)  (assoc :engagement/requires-th-entity? requires-th-entity?)
    (some? has-th-entity?)       (assoc :engagement/has-th-entity? has-th-entity?)
    (some? requires-dbd?)    (assoc :engagement/requires-dbd? requires-dbd?)
    (some? dbd-verified?)    (assoc :engagement/dbd-verified? dbd-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-th-entity? :engagement/has-th-entity?
   :engagement/requires-dbd? :engagement/dbd-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-th-entity? (boolean (:engagement/requires-th-entity? m))
     :has-th-entity? (boolean (:engagement/has-th-entity? m))
     :requires-dbd? (boolean (:engagement/requires-dbd? m))
     :dbd-verified? (boolean (:engagement/dbd-verified? m))
