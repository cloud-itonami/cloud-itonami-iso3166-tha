# cloud-itonami-iso3166-tha

Open ISO 3166 Blueprint for **THA**: Thailand.
...
tax registration, and local-content rules in Thailand, so the operator
...
- **Not the government of Thailand.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Thai-licensed counsel
...
(ISO 3166 `THA`). Required capabilities:
